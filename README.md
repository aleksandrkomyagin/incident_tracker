...
В микросервисе реализована проверка прав доступа, поэтому, чтобы сервис мог и создавать и читать инциденты, нужно указать соответствующие `scopes`(как в примере)
